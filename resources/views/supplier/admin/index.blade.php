            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-md-6" style="float:right; padding-right:1px">
                        @role('admin')
                            <a class="btn btn-info" style="float:right" href="{{ url('/admin/supplier/create') }}">Rekam Supplier</a>
                            @isset($jenis)
                                {!! Form::open(['url' => route('supplier.export'), 'method' => 'get', 'style'=>'float:right']) !!}
